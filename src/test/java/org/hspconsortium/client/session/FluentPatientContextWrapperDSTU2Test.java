...
public class FluentPatientContextWrapperDSTU2Test {

    private Session mockSession;
    private FluentSessionContextWrapperDSTU2 mockFluentSessionContextWrapperDSTU2;
    ...
    public void setUp() {
        ...
        mockFluentSessionContextWrapperDSTU2 = mock(FluentSessionContextWrapperDSTU2.class);
        ...
        when(mockSession.getContextDSTU2()).thenReturn(mockFluentSessionContextWrapperDSTU2);
        when(mockFluentSessionContextWrapperDSTU2.getPatientResource()).thenReturn(mockPatient);
    ...
    @Test
    public void testGet() {
        FluentPatientContextWrapperDSTU2 fluentPatientContextWrapperDSTU2 = new FluentPatientContextWrapperDSTU2(mockSession);

        assertEquals(mockPatient, fluentPatientContextWrapperDSTU2.get());
    }
    ...
    public void testFindNoParams() {
        ...
        assertEquals(mockObservation, fluentPatientContextWrapperDSTU2.find(Observation.class).iterator().next());
    }
    ...
    public void testFindWithParams() {
        ...
        assertEquals(mockObservation,
                fluentPatientContextWrapperDSTU2
