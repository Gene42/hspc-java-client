...
public class PatientContextWrapperSTU3Test {

    private Session mockSession;
    private SessionContextWrapperSTU3 mockSessionContextWrapperSTU3;
    ...
    public void setUp() {
        ...
        mockSessionContextWrapperSTU3 = mock(SessionContextWrapperSTU3.class);
        ...
        when(mockSession.getContextSTU3()).thenReturn(mockSessionContextWrapperSTU3);
        when(mockSessionContextWrapperSTU3.getPatientResource()).thenReturn(mockPatient);
    ...
    @Test
    public void testGet() {
        PatientContextWrapperSTU3 patientContextWrapperSTU3 = new PatientContextWrapperSTU3(mockSession);

        assertEquals(mockPatient, patientContextWrapperSTU3.get());
    }
    ...
    public void testFindNoParams() {
        ...
        assertEquals(mockObservation, patientContextWrapperSTU3.find(Observation.class).iterator().next());
    }
